...
//错import android.support.v7.widget.LinearLayoutManager;
...
public class ExercisesDetailActivity extends AppCompatActivity {
    ...
    //错private RecyclerView rv_list = (RecyclerView) findViewById(R.id.rv_list);
    ...
    private void init() {
        ...
        /*必要**/
        //错rv_list.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
